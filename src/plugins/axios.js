...
// https://backend.bonian.moltaqadev.com/dashboard-api/v1/
...
axios.interceptors.request.use(
  ...
  function (error) {
    ...
    if (error.response.status === 401) {
      localStorage.removeItem("bonian_admin_dashboard_user_id");
      localStorage.removeItem("bonian_admin_dashboard_user_token");
      localStorage.removeItem("bonian_admin_dashboard_userName");
      router.replace("/");
    }
